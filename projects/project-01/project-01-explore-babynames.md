...
plot_trends_in_name <- function(my_name) {
  tbl_names |> 
    ...
    labs(
      ...
      x = 'Year',
      y = 'Babies with the name {my_name}'
    ) +
    # Update plot theme
...
tbl_names_by_letter |> 
  ...
  labs(
    title = "Distribution of births by first letter in 2020",
    subtitle = "A is the most common first letter for female babies, J for male babies",
    x = "First Letter",
    y = "Percent Births"
  ) +
...
plot_trends_in_letter <- function(my_letter) {
  tbl_names_by_letter |> 
    ...
    labs(
      ...
      subtitle = glue::glue("{my_letter} is more popular for female than for male babies"),
      caption = "Source: SSA",
      x = "year",
      y = "Percent of Births"
    ) +
...
tbl_names_by_first_and_last_letter |> 
 ...
 labs(
   title = "Heat map of first letter vs last letter in 2021",
   subtitle = "A is the most common last letter, followed by E",
   x = "First Letter",
   y = "Last Letter"
 ) +
...
tbl_names_vowel_consonant |> 
  ...
  # Add labels (title, subtitle, caption, x, y)
      labs(
    title = "Trends in usage of consonants and vowels in baby names",
    subtitle = "Vowel ending is more popular for female than for male names",
    caption = "Source: SSA",
    x = "year",
